...
public enum TransactionText {
  ...
  MANAGER_INBOUND_LIST("1. 회원 입고 요청 승인 | 2. 입고 요청 수정 | 3. 입고 요청 취소 | 4. 뒤로가기"),
  ...
  MANAGER_OUTBOUND_LIST("1. 회원 출고 요청 승인 | 2. 출고 요청 수정 | 3. 출고 요청 취소 | 4. 뒤로가기"),
  ...
  APPROVED_OUTBOUNDS_LIST("-".repeat(50)+"<< 승인된 출고요청 내역 >>" + "-".repeat(50)),
  ...
  EMPTY_MEMBER_UNAPPROVED_OUTBOUND("미승인된 출고 요청이 있는 회원이 없습니다."),
  MEMBER_UNAPPROVED_OUTBOUNDS_HEADER("-".repeat(50)+"<< 출고 승인 요청 회원 ID 목록 >>" + "-".repeat(50)),
  MEMBER_UNAPPROVED_OUTBOUNDS_LIST(String.format("%-15s | %-15s\n", "회원 ID", "출고 요청 건수")),


  MEMBER_APPROVED_OUTBOUNDS_HEADER("-".repeat(50)+"<< 출고 승인 완료 회원 ID 목록 >>" + "-".repeat(50)),
  MEMBER_APPROVED_OUTBOUNDS_LIST(String.format("%-15s | %-15s\n", "회원 ID", "출고 승인 건수")),
  ...
  COMMON_APPROVED_OUTBOUND_LIST("1. 기간별 출고 현황 | 2. 월별 출고 현황 | 3. 뒤로가기"),
