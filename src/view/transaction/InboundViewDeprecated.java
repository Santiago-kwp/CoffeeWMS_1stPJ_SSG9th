...
import controller.transaction.InboundControllerDeprecated;
 ...
 */
public class InboundViewDeprecated {
  private static ValidCheck validCheck = new ValidCheck();
  private InboundControllerDeprecated controller;

  private final Scanner scanner;



  public InboundViewDeprecated(InboundControllerDeprecated controller) {
    this.controller = controller;
    this.scanner = new Scanner(System.in);
  }

  public void setController(InboundControllerDeprecated controller) {
    this.controller = controller;
  }
