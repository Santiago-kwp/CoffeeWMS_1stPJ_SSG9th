...
public interface InquiryDAO {
    ...
    List<Inquiry> readInquiryManagerAll();

    // 선택한 1:1 문의를 조회하는 기능으로 로그인한 유저가 작성한 문의만 조회할 수 있는 기능이다.
    Inquiry readInquiryMemberOne(String inquiryMemberId, Integer inquiryId);

    // 선택한 1:1 문의를 조회하는 기능으로 '총관리자' 권한을 가진 유저만 이 기능을 사용할 수 있다.
    Inquiry readInquiryManagerOne(Integer inquiryId);
